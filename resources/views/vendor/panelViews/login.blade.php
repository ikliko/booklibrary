    ...
    <div class="container">
        <div class="row">
            <div class="col-md-4 col-md-offset-4">
                ...
                <div class="mes-box ">
                    @if($mesType=='error')
                        <div class="error-box animated fadeInDown"><span class="ic-caution"></span> {{$message}}
                        </div>@endif
                    @if($mesType=='info')
                        <div class="info-box animated fadeInDown">{!!$message!!}</div>@endif
                </div>
                    ...
                    <div class="panel-body">
                        ...
                        <fieldset>
                            <div class="form-group">
                                ...
                                @endif
                                <input class="form-control" placeholder="{{ \Lang::get('panel::fields.email') }}"
                            ...
                            <div class="form-group">
                                ...
                                @endif
                                <input class="form-control" placeholder="{{ \Lang::get('panel::fields.password') }}"
                            ...
                            <input type="submit" class="btn btn-lg btn-success btn-block"
                                   value="{{ \Lang::get('panel::fields.login') }} ">
                        </fieldset>
                        {!! Form::close() !!}
                    </div>
                </div>
