                ...
                <div class="col-lg-3 col-md-6">
                    <div class="panel ">
                        ...
                        <div class="panel-footer">
                            ...
                            <a href='{{$box['showListUrl']}}'
                               class="pull-left">{{ \Lang::get('panel::fields.showList') }} <i
                                        class="icon ic-chevron-right"></i></a>
                            <div class="pull-right"><a class="add "
                                                       href="{{$box['addUrl']}}">{{ \Lang::get('panel::fields.Add') }}  </a>
                            </div>
