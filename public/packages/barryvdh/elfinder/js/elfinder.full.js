            ...
            this.draggable = {
                ...
                stop: function (e, ui) {
                    ...
                    if (!ui.helper.data('droped')) {
                        files = $.map(ui.helper.data('files') || [], function (h) {
                            return h || null;
                        });
                ...
                var self = fm ? fm : this,
                    ...
                    dfrd = $.Deferred()
                        ...
                        .always(function () {
                            ...
                            chunkMerge && self.ui.notify.children('.elfinder-notify-chunkmerge').length && self.notify({
                                type: 'chunkmerge',
                                cnt: -1
                            });
                        }),
                        ...
                        if (self.inputs.host.find('span').length) {
                            fm.request({
                                data: {
                                    ...
                                    user: 'init',
                                    pass: 'init',
                                    options: {url: fm.uploadURL, id: fm.id}
                                },
                                preventDefault: true
                            }).done(function (data) {
                    ...
                    $.each(types[type] || [], function (i, name) {
                        ...
                        if (cmd && cmd.getstate(targets) != -1) {
                            if (cmd.variants) {
                                ...
                                node.addClass('elfinder-contextmenu-group').hover(function () {
                                    hover();
                                });
    ...
    $.fn.elfinderplaces = function (fm, opts) {
        return this.each(function () {
            ...
            fm.one('load', function () {
                ...
                dirs = $.map((fm.storage(key) || '').split(','), function (hash) {
                    return hash || null;
                });
            ...
            var c = 'class', mobile = fm.UA.Mobile,
                ...
                replace = {
                    ...
                    cssclass: function (dir) {
                        return (fm.UA.Touch ? 'elfinder-touch ' : '') + (dir.phash ? '' : root) + ' ' + navdir + ' ' + fm.perms2class(dir) + ' ' + (dir.dirs && !dir.link ? collapsed : '');
                    },
